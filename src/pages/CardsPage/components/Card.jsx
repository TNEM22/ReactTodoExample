...
const Card = ({
  ...
  return (
    <div className="flex flex-col gap-0" style={{ zIndex: 1 }}>
      <DropArea
        ...
        >
          ...
          <div className="flex justify-between items-start">
            ...
            <div
              ...
              onBlur={() => setTimeout(() => setIsDialogOpen(false), 100)}
            >
              <span
                tabIndex={0}
                className={
              ...
              {isDialogOpen && (
                <div
                  className={
                    "absolute right-2 rounded shadow " +
                    (theme === "dark"
                      ? "shadow-white text-white bg-[#24262C]"
                      : "bg-white")
                  }
                >
                  <div
